...
impl<'a, C: FlashController<S>, const S: usize> AsyncTicKV<'a, C, S> {
    ...
    pub fn append_key(
        ...
        // FLUX-OPT addr=0x16900 flavor=slice_end
    ...
    pub fn set_read_buffer(&self, read_buffer: &[u8]) {
        ...
        // Notes: blocked-cell
        // FLUX-TODO addr=0x1d2ec flavor=unwrap_option
    ...
    pub fn continue_operation(&self) -> ContinueReturn {
        let (ret, length) = match self.tickv.state.get() {
            // FLUX-TODO addr=0x1826a flavor=unwrap_option
            ...
            State::AppendKey(_) => {
                ...
                // FLUX-TODO addr=0x18276 flavor=unwrap_option
            ...
            State::GetKey(_) => {
                ...
                // FLUX-TODO addr=0x1827c flavor=unwrap_option
                flux_support::assert(self.key.get().is_some());
            ...
            // FLUX-TODO addr=0x18270 flavor=unwrap_option
            ...
            // FLUX-TODO addr=0x18252 flavor=explicit_panic
