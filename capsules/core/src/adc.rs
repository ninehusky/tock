    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1e4ba] reason=lto-inlined-fn-entry flavor=explicit_panic
    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1eaea] reason=lto-inlined-fn-entry flavor=explicit_panic
