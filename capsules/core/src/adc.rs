    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1e6ba] reason=lto-inlined-fn-entry flavor=explicit_panic
    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1eca6] reason=lto-inlined-fn-entry flavor=explicit_panic
