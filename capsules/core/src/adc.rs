    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1e696] reason=lto-inlined-fn-entry flavor=explicit_panic
    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1ef7a] reason=lto-inlined-fn-entry flavor=explicit_panic
