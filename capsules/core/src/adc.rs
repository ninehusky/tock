    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1eab2] reason=lto-inlined-fn-entry flavor=explicit_panic
    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1f0de] reason=lto-inlined-fn-entry flavor=explicit_panic
