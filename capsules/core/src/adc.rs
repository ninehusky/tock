    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1e432] reason=lto-inlined-fn-entry flavor=explicit_panic
    ...
    for AdcDedicated<'a, A>
{
    ...
    // FLUX-TODO-FN-LEVEL addrs=[0x1ea62] reason=lto-inlined-fn-entry flavor=explicit_panic
